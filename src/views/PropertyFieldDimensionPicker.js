...
import Screenshot from '../images/PropertyFieldDimensionPicker.gif';

const PropertyFieldDimensionPicker = () => (
  <div>
    <h2>Dimension Picker</h2>

    <p>
      This component generates a Dimension Picker property field in your client side web part for 
    ...
    <pre>
import  &#123; IPropertyFieldDimension &#125; from 'sp-client-custom-fields/lib/PropertyFieldDimensionPicker';<br/>
<br/>
export interface IMyWebPartProps &#123;<br/>
&nbsp;&nbsp;dimension: IPropertyFieldDimension;<br/>
&#125;
    </pre>
    <p>
    ...
    <pre>
import &#123; <strong>PropertyFieldDimensionPicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldDimensionPicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldDimensionPicker</strong>('dimension', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a dimension',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.dimension,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;preserveRatio: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;preserveRatioEnabled: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>no</td>
          <td>boolean</td>
          <td>Whether the aspect ratio is checked or not by default. Default value is true.</td>
        </tr>
        <tr>
          <td>preserveRatioEnabled</td>
          <td>no</td>
          <td>boolean</td>
          <td>Whether the aspect ratio checkbox is available or not. Default value is true.</td>
        </tr>
        <tr>
          <td>disabled</td>
          <td>no</td>
    ...
    <p>
      This custom field returns a value with the following properties
    </p>
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfielddimensionpicker_.html">
...
export default PropertyFieldDimensionPicker;
