...
import Screenshot from '../images/PropertyFieldStarRating.gif';

const PropertyFieldStarRating = () => (
  <div>
    <h2>Star Rating</h2>

    <p>
      This component generates a star rating property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="Star Rating"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldStarRating</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldStarRating';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldStarRating</strong>('starRating', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a rate',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.starRating,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;starCount: 5,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;starSize: 24,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;starColor: '#ffb400',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;emptyStarColor: '#333',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>no</td>
          <td>number</td>
          <td>Number of icons in rating, default 5.</td>
        </tr>
        <tr>
          <td>starColor</td>
          <td>no</td>
          <td>string</td>
          <td>Color of selected icons, default #ffb400.</td>
        </tr>
        <tr>
          <td>starSize</td>
          <td>no</td>
          <td>number</td>
          <td>Star size, default 24.</td>
        </tr>
        <tr>
          <td>emptyStarColor</td>
          <td>no</td>
          <td>string</td>
          <td>Color of non-selected icons, default #333.</td>
        </tr>
        <tr>
          <td>disabled</td>
          <td>no</td>
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldstarrating_.html">
...
export default PropertyFieldStarRating;
