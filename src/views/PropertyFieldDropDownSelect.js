...
import Screenshot from '../images/PropertyFieldDropDownSelect.gif';

const PropertyFieldDropDownSelect = () => (
  <div>
    <h2>DropDown Select</h2>

    <p>
      This component generates a DropDown with select boxes property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="DropDown Select"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldDropDownSelect</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldDropDownSelect';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldDropDownSelect</strong>('dropDownSelect', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select values',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.dropDownSelect,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;options: [<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfielddropdownselect_.html">
...
export default PropertyFieldDropDownSelect;
