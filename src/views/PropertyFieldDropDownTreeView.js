...
import Screenshot from '../images/PropertyFieldDropDownTreeView.gif';

const PropertyFieldDropDownTreeView = () => (
  <div>
    <h2>DropDown TreeView</h2>

    <p>
      This component generates a DropDown with a Treeview property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="DropDown TreeView"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldDropDownTreeView</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldDropDownTreeView';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldDropDownTreeView</strong>('dropDownTreeView', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select values',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;selectedNodesIDs: this.properties.dropDownTreeView,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfielddropdowntreeview_.html">
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/interfaces/_propertyfielddropdowntreeview_.idropdowntreeviewnode.html">
        View the complete custom field API documentation</a>
      </p>
...
export default PropertyFieldDropDownTreeView;
