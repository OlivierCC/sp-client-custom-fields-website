...
import Screenshot from '../images/PropertyFieldColorPicker.gif';

const PropertyFieldColorPicker = () => (
  <div>
    <h2>Color Picker</h2>

    <p>
      This component generates a Color Picker property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="Color Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldColorPicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldColorPicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldColorPicker</strong>('color', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a color',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialColor: this.properties.Color,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldcolorpicker_.html">
