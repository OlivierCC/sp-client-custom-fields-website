...
import Screenshot from '../images/PropertyFieldFontSizePicker.gif';

const PropertyFieldFontSizePicker = () => (
  <div>
    <h2>Font Size Picker</h2>

    <p>
      This component generates a Font Size Picker property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="Font Size Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldFontSizePicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldFontSizePicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldFontSizePicker</strong>('fontSize', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a font size',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.fontSize,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usePixels: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;preview: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>no</td>
          <td>boolean</td>
          <td>Uses pixels ('12px') or label ('xx-large') mode.</td>
        </tr>
        <tr>
          <td>preview</td>
          <td>no</td>
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldfontsizepicker_.html">
...
export default PropertyFieldFontSizePicker;
