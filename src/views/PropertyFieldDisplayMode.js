...
import Screenshot from '../images/PropertyFieldDisplayMode.gif';

const PropertyFieldDisplayMode = () => (
  <div>
    <h2>Display Mode</h2>

    <p>
      This component generates a Display Mode property field in your client side web part for 
      the SharePoint Framework:</p>
    <p>
      <img src={Screenshot} width="606" alt="Display Mode"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldDisplayMode</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldDisplayMode';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldDisplayMode</strong>('displayMode', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a display mode',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.displayMode,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfielddisplaymode_.html">
...
export default PropertyFieldDisplayMode;
