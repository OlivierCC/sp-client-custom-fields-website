...
import Screenshot from '../images/PropertyFieldIconPicker.gif';

const PropertyFieldIconPicker = () => (
  <div>
    <h2>Icon Picker</h2>

    <p>
      This component generates an Icon Picker property field in your client side web part for 
      the SharePoint Framework. This control uses the complete collection of Office UI Fabric icons 
      styles available at <a href="http://dev.office.com/fabric/styles#icons">http://dev.office.com/fabric/styles#icons</a>.
    </p>
    <p>
      <img src={Screenshot} width="606" alt="Icon Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldIconPicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldIconPicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldIconPicker</strong>('icon', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select an icon',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.icon,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;orderAlphabetical: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;preview: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
  ...
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          <td>orderAlphabetical</td>
          <td>no</td>
          <td>boolean</td>
          <td>Uses MSDN order or alphabetical for icons (default is true).</td>
        </tr>
        <tr>
          <td>preview</td>
          <td>no</td>
          <td>boolean</td>
          <td>Preview the fonts in the dropdown control (default is true).</td>
        </tr>
        <tr>
          <td>disabled</td>
          <td>no</td>
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldiconpicker_.html">
...
export default PropertyFieldIconPicker;
