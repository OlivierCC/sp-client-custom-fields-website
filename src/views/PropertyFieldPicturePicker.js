...
import Screenshot from '../images/PropertyFieldPicturePicker.gif';

const PropertyFieldPicturePicker = () => (
  <div>
    <h2>Picture Picker</h2>

    <p>
      This component generates a Picture Picker property field in your client side web part for 
      the SharePoint Framework. With this custom field, you can select a picture from the current site libraries.</p>
    <p>
      <img src={Screenshot} width="606" alt="Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldPicturePicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldPicturePicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldPicturePicker</strong>('picture', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a picture',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.picture,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readOnly: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;previewImage: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;allowedFileExtensions: '.gif,.jpg,.jpeg,.bmp,.dib,.tif,.tiff,.ico,.png',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>no</td>
          <td>boolean</td>
          <td>Whether the image path can be edit manually or not. Default is true.</td>
        </tr>
        <tr>
          <td>previewImage</td>
          <td>no</td>
          <td>string</td>
          <td>Whether the image preview is enabled or not. Default is true.</td>
        </tr>
        <tr>
          <td>allowedFileExtensions</td>
          <td>no</td>
          <td>string</td>
          <td>Defines the file extensions allowed in the picker. You need to specifies all the 
            extensions with a dot and to separate them with a comma without spaces. For example a good value is: '.gif,.png,.jpg'. 
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldpicturepicker_.html">
...
export default PropertyFieldPicturePicker;
