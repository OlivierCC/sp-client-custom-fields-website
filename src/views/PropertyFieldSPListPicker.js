...
import Screenshot from '../images/PropertyFieldSPListPicker.gif';

const PropertyFieldSPListPicker = () => (
  <div>
    <h2>SharePoint List Picker</h2>
    ...
    <p>
      <img src={Screenshot} width="606" alt="SharePoint List Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldSPListPicker, PropertyFieldSPListPickerOrderBy</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldSPListPicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldSPListPicker</strong>('list', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a list',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;selectedList: this.properties.list,<br/>
...
&nbsp;&nbsp;&nbsp;]<br/>
  &#125;;
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldsplistpicker_.html">
...
export default PropertyFieldSPListPicker;
