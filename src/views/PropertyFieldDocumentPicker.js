...
import Screenshot from '../images/PropertyFieldDocumentPicker.gif';

const PropertyFieldDocumentPicker = () => (
  <div>
    <h2>Document Picker</h2>

    <p>
      This component generates a Document Picker property field in your client side web part for 
      the SharePoint Framework. With this custom field, you can select a document from the current site libraries.</p>
    <p>
      <img src={Screenshot} width="606" alt="Document Picker"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldDocumentPicker</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldDocumentPicker';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldDocumentPicker</strong>('document', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a document',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.document,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readOnly: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;previewDocument: true,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;allowedFileExtensions: '.doc,.docx,.ppt,.pptx,.xls,.xlsx,.pdf,.txt',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
  ...
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          <td>previewDocument</td>
          <td>no</td>
          <td>string</td>
          <td>Whether the document preview is enabled or not. Default is true.</td>
        </tr>
        <tr>
          ...
          <td>Defines the file extensions allowed in the picker. You need to specifies all the 
            extensions with a dot and to separate them with a comma without spaces. For example a good value is: '.doc,.docx,.pptx'. 
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfielddocumentpicker_.html">
...
export default PropertyFieldDocumentPicker;
