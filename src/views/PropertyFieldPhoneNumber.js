...
import Screenshot from '../images/PropertyFieldPhoneNumber.gif';

const PropertyFieldPhoneNumber = () => (
  <div>
    <h2>Phone Number</h2>

    <p>
      This component generates a Phone Number property field in your client side web part for 
      the SharePoint Framework. This control shows a masked input control based on phone number format and controls the input value.</p>
    <p>
      <img src={Screenshot} width="606" alt="Phone Number"/>
    </p>
...
&#125;
    ...
    <pre>
import &#123; <strong>PropertyFieldPhoneNumber, IPhoneNumberFormat</strong> &#125; from 'sp-client-custom-fields/lib/PropertyFieldPhoneNumber';
    </pre>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;groupFields: [<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>PropertyFieldPhoneNumber</strong>('phoneNumber', &#123;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;label: 'Select a phone number',<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;initialValue: this.properties.phoneNumber,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;phoneNumberFormat: IPhoneNumberFormat.UnitedStates,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;disabled: false,<br/>
  ...
  &#125;;
    ...
    <table cellSpacing="0" cellPadding="0">
      ...
      <tbody>
        ...
        <tr>
          <td>phoneNumberFormat</td>
          <td>yes</td>
          <td>IPhoneNumberFormat</td>
          <td>Defines the phone number format with a choice of different countries specific formats. You can find
            the complete list of all the supported phone formats <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/enums/_propertyfieldphonenumber_.iphonenumberformat.html">here</a>
          </td>
        </tr>
        <tr>
          <td>disabled</td>
    ...
    <p>
        <a href="https://oliviercc.github.io/sp-client-custom-fields/docs/modules/_propertyfieldphonenumber_.html">
...
export default PropertyFieldPhoneNumber;
